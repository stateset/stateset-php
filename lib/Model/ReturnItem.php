...
class ReturnItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets requested_date
     *
     * @param \DateTime|null $requested_date The date the return was requested
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount The total amount refunded for the return
     *
     * @return self
     */
     ...
     * Sets tax_refunded
     *
     * @param string|null $tax_refunded The amount of tax refunded for the return
     *
     * @return self
     */
     ...
     * Sets total_refunded
     *
     * @param string|null $total_refunded The total amount refunded for the return, including tax
     *
     * @return self
     */
